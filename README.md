...
Forward 12개월 EPS(NTM EPS) 기반 모멘텀 시스템. 이익 추정치 변화율로 종목을 선별하고, 주가 미반영 종목을 매수 후보로 제시. AI(Gemini)가 매수 후보의 최근 뉴스를 스캔.
...
Part 2 매수 후보 30종목을 Gemini 2.5 Flash + Google Search Grounding으로 뉴스 스캔.
AI 역할: 분석/판단 없이 팩트만 전달하는 **뉴스 스캐너**.
- 최근 1~2주 중요 뉴스/이벤트 (악재 또는 호재)
- 2주 내 실적발표(earnings) 예정 여부
- 특이사항 없는 종목은 보고하지 않음
- 출력: 1500자 이내

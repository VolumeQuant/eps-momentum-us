# EPS Revision Momentum Strategy v7.1.8 (US Stocks)

미국 주식 대상 **밸류+가격 100점 체계** 전략 시스템

> 🇺🇸 **핵심 철학**: "좋은 사과를 싸게 - 밸류(맛) + 가격(값) 균형"

## v7.1.6 주요 변경 (2026-02-05)

| 기능 | 설명 |
|------|------|
| **점수 체계 개편** | 밸류 100점 + 가격 100점, 총점 = 밸류×50% + 가격×50% |
| **EPS 모멘텀 가중치** | 최근일수록 높은 가중치 (7일 24점 > 30일 22점 > 60일 18점 > 90일 16점) |
| **텔레그램 자동화** | TOP 10 + 11-26위 메시지 자동 생성, 불릿 포인트 선정이유 |
| **섹터 분석** | 한글+영문 섹터명, ETF 추천, 주도섹터 표시 |
| **신고가 돌파** | 감점만 안 함 (보너스 제거) - 비싸면 비싼 것 |
...
| v7.1.2 | 2026-02-05 | 섹터 분석을 TOP 10 앞으로 이동 |
| v7.1.1 | 2026-02-05 | 신고가 RSI 점수 조정, 핵심추천 삭제, 섹터 분석 추가 |

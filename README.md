# EPS Revision Momentum Strategy v7.1 (US Stocks)

미국 주식 대상 **밸류+가격 100점 체계** 전략 시스템

> 🇺🇸 **핵심 철학**: "좋은 사과를 싸게 - 밸류(맛) + 가격(값) 균형"

## v7.1 주요 변경 (2026-02-05)
...
| **핵심추천 자동분류** | 적극매수/급락저가매수/분할진입/돌파확인/조정대기 |
| **순위 아이콘** | 🥇1위 🥈2위 🥉3위 📌4위~ |
...
**신고가 돌파 모멘텀**: 52주 고점 -2% 이내면 RSI 과매수(70+)도 OK → 가격 80점+
...
| 카테고리 | 조건 | 설명 |
|----------|------|------|
| ✅ **적극매수** | RSI≤35 AND 가격≥80 | 과매도 급락 기회 |
| 💰 **급락저가매수** | 가격≥80 AND 밸류<65 | 가격은 좋지만 밸류 낮음 |
| 🔄 **분할진입** | 밸류≥70 AND RSI 40-60 | 밸류 좋고 RSI 중립 |
| ⏸️ **돌파확인** | 52주 -2% 이내 AND RSI≥70 | 신고가 돌파 대기 |
| ⏸️ **조정대기** | RSI≥70 | RSI 과열 |
...
- `get_recommendation_category_v71(row)` - 핵심추천 분류

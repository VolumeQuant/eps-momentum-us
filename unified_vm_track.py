...
#   ★★급락컷과의 의존관계 (2026-08-04 실측, 반드시 함께 켜고 함께 끌 것):
#     밴드는 '이미 가진 종목을 더 오래 붙잡는' 장치라 붙잡을 가치가 있는 종목일 때만 이득이다.
#       급락컷 없이 밴드만: Calmar 16.24 → 15.61 (악화), LOWO 14.15 → 13.43, WF 24/14/19/17
#       급락컷 있고 밴드만 추가: 21.56 → 23.44 (개선), LOWO 18.77 → 18.99, WF 58/45/48/48
#     급락컷이 먼저 걸러내고 밴드가 남은 것을 오래 들고 가는 2단 구조. 하나만 켜면 손해다.

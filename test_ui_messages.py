...
fake_portfolio_msg = '\n'.join([
    ...
    '<b>Apple(AAPL)</b>',
    '비중 25%',
    '꾸준한 EPS 상승과 안정적인 주가 흐름이 매력적이에요.',
    '──────────────────',
    '<b>Southwest Airlines(LUV)</b>',
    '비중 20%',
    'EPS가 42% 급등하며 반등 추세에 있어요. 저평가 매력이 커요.',
    '──────────────────',
    '<b>Alcoa(AA)</b>',
    '비중 15%',
    '알루미늄 가격 상승과 함께 EPS가 65% 폭등 중이에요.',
    '──────────────────',
    '<b>Freeport-McMoRan(FCX)</b>',
    '비중 10%',
    '구리 수요 증가로 EPS가 안정적으로 올라가고 있어요.',
    '',
    '시스템 데이터 기반 참고용이며, 투자 판단은 본인 책임이에요.',
    '',
    '💡 <b>활용법</b>',
    '· 비중대로 분산 투자를 권장해요',
    '· 목록에서 빠지면 매도 검토',

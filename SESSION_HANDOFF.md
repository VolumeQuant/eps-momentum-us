...
- 현금 50%이면 → 5종목 × 10% = 50% 주식
- 현금 20%이면 → 5종목 × 16% = 80% 주식
...
| Q2 성장 | - | 20% | 정상 운영 | 연율 +9.4%, 양수확률 84% |
| Q3 과열 | <60일 | 20% | 주의 관찰 | 60일 +1.84%, 아직 양수 |
| Q3 과열 | ≥60일 | 30% | 신규 진입 축소 | 60일 +0.39%, 거의 제로 |
| Q4 침체 | 1~20일 | 30% | 신규 매수 중단 | 60일 +3.37% (반등), 급매도 금지 |
| Q4 침체 | 21~60일 | 50% | 단계적 축소 | 60일 +0.54%, 모멘텀 약화 |
| Q4 침체 | 61일+ | 70% | 적극 방어 | 60일 **-2.38%**, 본격 하락 |

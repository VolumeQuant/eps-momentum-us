...
> **v71**: 2026-03-30 — HY×VIX RETURN_MATRIX 교정(6,593거래일 검증). 역변동성→균등비중. 상관관계 🔗 유사도% BFS 그룹핑. S&P500 명시, HY/VIX 괄호+콜론. portfolio_mode `normal` 확정. 선정과정 고객친화. conviction: adj_gap×(1+max(up/N, min(|eps_chg|/100,1))). 괴리→z-score 점수(avg65, 1std=15, 30~100). DB 32일 part2_rank 전체 재계산

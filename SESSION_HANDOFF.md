...
> **v71**: 2026-03-26 — HY×VIX RETURN_MATRIX 교정: 6,593거래일(2000~2026) SPY 20일 선행수익률로 16칸 매트릭스 재검증. Q3+crisis +2.7→+15.3%, Q4+elevated +12.1→-12.1% 등 부정확 값 수정. 거짓 🔴 제거. portfolio_mode 하드코딩 `normal` 유지 확정(비중 축소 시 알파 소멸 검증). S&P→S&P500 명시. HY/VIX 퍼센타일 괄호+콜론 표기

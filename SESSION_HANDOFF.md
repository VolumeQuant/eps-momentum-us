...
**Last Updated:** 2026-02-04 08:28
**Session:** 2026-02-04 스크리닝 완료 - YELLOW 모드 (2개 통과: AVGO, AMGN)
...
### 통과 종목: 2개
| 티커 | 종목명 | 점수 | 섹터 | 액션 | Forward PER | ROE |
|------|--------|------|------|------|-------------|-----|
| AVGO | Broadcom Inc. | 11.7 | 반도체 | 저점매수 | 22.3 | 31.1% |
| AMGN | Amgen Inc. | 9.2 | 헬스케어 | 관망 | 15.3 | 81.7% |
...
### 비고
- YELLOW 모드로 필터 강화 (Score >= 6.0)
- 어제 54개 → 오늘 2개로 대폭 감소
- Track 2 데이터 수집 오류 (767개 실패) - yfinance API 불안정

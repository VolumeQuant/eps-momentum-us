...
> **v71**: 2026-03-30 — HY×VIX RETURN_MATRIX 교정(6,593거래일 검증). 역변동성→균등비중. 상관관계 🔗 유사도% BFS 그룹핑. S&P500 명시, HY/VIX 괄호+콜론. portfolio_mode `normal` 확정. 선정과정 고객친화. conviction 가중: adj_gap×(1+rev_up/analysts). 괴리%→100점 만점 점수제(eligible 퍼센타일 기반, conviction 반영)

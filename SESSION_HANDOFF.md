...
> **v34**: 2026-02-19 집 PC — UX 대폭 개선: 읽는 법 각 메시지 상단 이동, 날씨 아이콘 설명, 아이콘 교체(🛡️→🚨🤖), [3/4] 어제 마감 집중, [4/4] AI 긍정 멘트+비중요약 삭제+주의사항 정리+퍼널 간결화, 국내 프로젝트 동기화
...
- AI 프롬프트 전면 개편: 긍정 매력만, 주의/경고 표현 금지, 250자 이내

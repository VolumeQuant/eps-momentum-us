...
> **v27**: 2026-02-13 집 PC — 시장 위험 지표 리네임 + 사계절 라벨 + 애널리스트 데이터 DB 저장 버그 수정
...
|------|-------------|-------------|
| 섹션 제목 | 🟢 **신용시장** — 성장기 | 🛡️ **시장 위험 지표** — 🌻 여름 |
| HY 스프레드 | HY Spread(부도위험) | 🏦 HY 스프레드 |
| VIX | 📊 VIX(변동성) | 🌡️ VIX |
| 투자 비중 | 📊 투자 80% | 💰 투자 80% |
| 분면 라벨 | 회복기/성장기/과열기/침체기 | 🌸봄/🌻여름/🍁가을/❄️겨울 |
...
- 🌡️ VIX (온도계 = 변동성 체감)
- 💰 투자 비중 (돈주머니 = 자산 배분)
- VIX regime 아이콘도 📊 → 🌡️ 변경 (normal, stabilizing)

...
> **v27**: 2026-02-13 집 PC — 시장 위험 지표(신용시장+변동성 하위 카테고리) + 사계절 라벨 + 애널리스트 DB 저장 수정
...
| 하위 카테고리 | 없음 (HY/VIX 평렬) | 🏦 **신용시장** + 🌡️ **변동성** |
| HY 스프레드 | HY Spread(부도위험) | 🏦 신용시장 → HY 스프레드 |
| VIX | 📊 VIX(변동성) | 🌡️ 변동성 → VIX |
| 투자 비중 | 📊 투자 80% | 💰 투자 80% |
...
- 🏦 신용시장 (은행 = HY 스프레드 하위 카테고리)
- 🌡️ 변동성 (온도계 = VIX 하위 카테고리)
- 💰 투자 비중 (돈주머니 = 자산 배분)

...
### 태그 시스템 재설계
- **2축 독립 판정**: 가격(주가 변동%)과 전망(adj_score)을 각각 독립적으로 판정
...
- **중복 표시**: 둘 다 임계값 넘으면 둘 다 표시 (예: 💪전망↑ 📉가격↓)
- **사실 전달, 해석 배제**: 보유자/매수검토자 모두 같은 사실로 각자 판단

### 태그 4종 (9종 조합)
| 태그 | 설명 | 조건 |
|---|---|---|
| 📈가격↑ | 가격이 올랐어요 | 주가 변동 ≥ +2.83% (1σ) |
| 📉가격↓ | 가격이 내렸어요 | 주가 변동 ≤ -2.83% (1σ) |
| 💪전망↑ | 전망이 좋아졌어요 | adj_score Δ ≥ +1.48 (1σ) |
| ⚠️전망↓ | 전망이 나빠졌어요 | adj_score Δ ≤ -1.48 (1σ) |

조합 매트릭스:
| 전망 \ 가격 | 가격↑ | 가격↓ | 변동없음 |
|---|---|---|---|
| 전망↑ | 💪전망↑ 📈가격↑ | 💪전망↑ 📉가격↓ | 💪전망↑ |
| 전망↓ | ⚠️전망↓ 📈가격↑ | ⚠️전망↓ 📉가격↓ | ⚠️전망↓ |
| 변동없음 | 📈가격↑ | 📉가격↓ | 태그 없음 |

### 표시 형식
- 순위 줄 끝에 괄호로 표시: `의견 ↑20↓0 · 순위 4→11→14 (📈가격↑)`
- 복합 태그: `의견 ↑20↓0 · 순위 4→11→14 (📈가격↑ ⚠️전망↓)`
- 설명문 없이 짧은 라벨만 (줄바꿈 방지)

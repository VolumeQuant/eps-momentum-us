...
2. **약세장 sub-period 약점 검증됨**:
   - 3/20~4/4 (이란 전쟁 trough 10일): baseline +3.65% / 새 후보 -8.63%, **-12.29%p 손해**
   - 3/13~4/10 (Crisis 회복 포함 20일): +10.38%p 우월
   - **좁은 stress만 보면 약점, 회복 포함하면 우월** — 빠른 회복 활용 능력이 강점
   - 진짜 장기 약세장 (SPY -20%+ 6개월) 미검증
3. **표본 작음** (11~12건 trade) — MU +103% 같은 단일 케이스 의존성 일부
4. **거래 비용 stress test 통과** — 1% cost 가정해도 +39.12%p 우월 (수수료 0.2% + 슬리피지 0.1~0.3% 합리적 가정 내 안전)
5. trade 수 보존 — 새 후보 13.3건 vs baseline 14.8건 (슬롯 축소로 회전 ↓)

### 약세장 sub-period 상세

| Period | baseline | 새 후보 | 차이 |
|---|---|---|---|
| Early Stress (2/13~3/13, 20일) | +3.24% MDD -18.11% | +10.87% MDD -19.82% | +7.62%p |
| Crisis (3/13~4/10, 20일) | +38.15% MDD -13.63% | +48.53% MDD -13.01% | +10.38%p |
| Recovery (4/10~5/8, 21일) | +67.31% MDD -5.15% | +72.52% MDD -4.36% | +5.21%p |
| Late (5/8~5/22, 11일) | +1.99% MDD -9.67% | +15.95% MDD -2.14% | +13.96%p |
| **Stress Only (3/20~4/4, 10일)** | **+3.65% MDD -14.76%** | **-8.63% MDD -19.60%** | **-12.29%p** |

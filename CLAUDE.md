# 🇺🇸 US 전략 — eps-momentum-us (v121 VIX텀구조 진입가속, v119b fwd_PER<30, 메인 cron 활성, 2026-06-14)

> **★ v121: VIX 텀구조 빠른진입 가속 — 적용완료 (2026-06-14, daily_runner get_market_regime)**: VIX/VIX3M 백워데이션(단기공포 선폭발)=빠른약세장 선행경보. MA200 아래서 텀구조 역전(>1.08) 2일 → 15일 안기다리고 조기방어(재진입은 15일 그대로). 전문가자문+검증(research/regime_eda_phase13_expert, 26년QQQ프록시): Calmar 0.63→0.71, **2018Q4 −16%→−7%·2025 −18%→−9% 조기탐지**, ★LOWO(2020/2025제외) 0.69→0.75 통과, 2008/2022 무손상(느린약세장 텀구조 미발화), 인접·비용 통과. 무역전시 기존과 동일. 킬스위치 REGIME_TS_DISABLE=1, VIX3M실패시 MA200폴백. 상수 REGIME_TS_THRESH=1.08(1.05→1.08 헛방어차단)/CONFIRM=2. ⚠️QQQ프록시·N=3. **(미적용 메타옵션) 조기50%축소(phase14): MA100이탈시 시스템비중 50%→MA200전량 = binary보다 Cal0.37→0.42·MDD−37→−31%, 단 부분포지션 필요라 메타배분 레벨 권고.**

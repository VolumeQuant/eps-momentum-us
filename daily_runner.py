...
[Greedy — Top 5 우선 커버]
핵심 규칙: 1~5위 종목은 반드시 모두 커버해야 해. Top 5 미커버 종목이 남아있으면 해당 종목이 포함된 ETF를 우선 선택.

Step A: 과제B에서 가장 많은 종목(특히 Top 5)을 커버하는 ETF 선택.
→ 커버: [...] | 미커버: [...]
Step B: 미커버 중 Top 5 미커버가 있으면 그것부터 커버하는 ETF 추가.
→ 누적 커버: [...] | 미커버: [...]

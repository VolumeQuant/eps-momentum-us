...
def main():
    ...
    ai_content = {
        'market_summary': '트럼프의 10% 글로벌 관세 무효화 판결에 시장이 안도하며 기술주 중심으로 상승 마감했어요.\n반도체·AI 관련주가 강세를 보였고, 에너지·헬스케어는 약보합이었어요.\nNVDA 실적발표(2/26)가 다가오면서 AI 투자 지속 여부에 관심이 집중되고 있어요.\n성장 국면 35일째로 모멘텀이 유지되고 있어요. 평소대로 투자하세요.',
        'narratives': {}
    }
